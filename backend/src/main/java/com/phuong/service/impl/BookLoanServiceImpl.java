...
import com.phuong.domain.BookLoanType;
import com.phuong.exception.BookException;
import com.phuong.exception.BookLoanException;
import com.phuong.exception.SubscriptionException;
import com.phuong.exception.UserException;
import com.phuong.mapper.BookLoanMapper;
import com.phuong.modal.Book;
import com.phuong.modal.BookLoan;
import com.phuong.modal.User;
import com.phuong.payload.CheckoutStatistics;
import com.phuong.payload.dto.BookLoanDTO;
import com.phuong.payload.dto.SubscriptionDTO;
import com.phuong.payload.request.BookLoanSearchRequest;
import com.phuong.payload.request.CheckinRequest;
import com.phuong.payload.request.CheckoutRequest;
import com.phuong.payload.request.RenewalRequest;
...
import com.phuong.service.BookLoanService;
import com.phuong.service.FineCalculationService;
import com.phuong.service.ReservationService;
import com.phuong.service.SubscriptionService;
...
public class BookLoanServiceImpl implements BookLoanService {
    ...
    @Override
    public BookLoanDTO updateBookLoan(Long bookLoanId, com.phuong.payload.request.UpdateBookLoanRequest updateRequest) throws BookLoanException {
        // 1. Validate book loan exists
        BookLoan bookLoan = bookLoanRepository.findById(bookLoanId)
                .orElseThrow(() -> new BookLoanException("Book loan not found with id: " + bookLoanId));
